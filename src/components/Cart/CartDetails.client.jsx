...
/* Order Summary (Total, iva, costo de envio, etc.) */
...
/* Vista del producto en el carrito (imagen, descripcion, precio, etc.) */
...
/* Cantidad en el carrito, y opcion para aumentar o disminuirla, asi como tambien borrar el producto del carrito */
